...
const PROVIDER_INFO: Record<string, { 
  ...
  openai: {
    ...
    models: [
      { id: "gpt-5.4-mini", name: "GPT-5.4-mini", description: "Most capable, multimodal", recommended: true },
      { id: "gpt-5.4", name: "GPT-5.4", description: "Best performance" },
      { id: "gpt-5", name: "GPT-5", description: "Fast GPT-5" },
    ],
  },
  gemini: {
    name: "Google Gemini",
    ...
    models: [
      { id: "gemini-2.5-pro", name: "Gemini 2.5 Pro", description: "Previous generation", recommended: true},
  ...
  claude: {
    ...
    description: "Claude 4.6 - excellent for analysis and reasoning",
    docsUrl: "https://console.anthropic.com/settings/keys",
    models: [
      { id: "claude-opus-4.6", name: "Claude 4.6 Opus", description: "Most capable", recommended: true },
      { id: "claude-sonnet-4.6", name: "Claude 4.6 Sonnet", description: "Balanced" },
      { id: "claude-haiku-4.6", name: "Claude 4.6 Haiku", description: "Fastest" },
    ],
  },
};
